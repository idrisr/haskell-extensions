...
\chapter{Datatype promotion---DataKinds}
\url{https://ghc.gitlab.haskell.org/ghc/doc/users_guide/exts/data_kinds.html}

\setcounter{chapter}{16}
\chapter{Visible type application---TypeApplications}
...
\chapter{Generalised derived instances for newtypes---GeneralisedNewtypeDeriving}
